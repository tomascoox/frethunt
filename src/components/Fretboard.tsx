                ...
                activeGameMode === 'memory' && memoryGameActive && (
                    <div className="w-full flex flex-col items-center mt-1 mb-6 sm:mt-4 sm:mb-8 px-4">
                        ...
                        <button
                            ...
                            className="h-8 px-6 sm:h-12 sm:px-8 rounded-lg font-bold text-xs sm:text-base bg-slate-700 text-slate-300 border border-slate-600 hover:bg-slate-600 transition-all shadow-lg shadow-black/40"
                        >
                            STOP HUNTING
                        </button>
                    </div>
